<template>
    <div class="min-h-screen bg-gray-100">
        ...
        <section class="flex gap-4 justify-center py-6">
            <select v-model="selectedPeriod" class="border rounded-1g px-4 py-2">
        ...
        <section class="px-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div v-for="u in filteredUsers" :key="u.id"
                class="bg-blue-100 rounded-2x1 p-6 shadow hover:shadow-lg transition">
                ...
                <div class="mt-6 flex justify-end">
                    <router-link :to="`/evaluator/assignments/${u.id}`"
