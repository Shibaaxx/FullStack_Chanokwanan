<template>
    <div class="min-h-screen bg-gray-100 p-10" style="font-family: 'Prompt', sans-serif,">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md">
            <botton @click="clearEvaluations" class="mt-4 bg-red-500 hover
            :bg-red-600 text-white px-4 py-2 rounded-lg mb-5">
                ลบข้อมูลรายงานทั้งหมด
            </botton>
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-blue-200 text-gray-700">
                        <th class="border p-2">ลาดบ</th>
                ...
                <tbody>
                    <tr v-for="(item, index) in evaluations" :key="index" class="hover:bg-gray-50">
                        ...
                        <td class="border p-2 text-center font-semibold text-blue-700">{{ item.
                            totalScore }}</td>
