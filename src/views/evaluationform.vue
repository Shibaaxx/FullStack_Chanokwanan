<template>
  <div class="min-h-screen p-8 bg-gray-100" style="font-family: 'Prompt', sans-serif;">
    ...
    <div v-if="assignment" class="bg-white p-6 rounded-x1 shadow-md max-w-x1 mx-auto">
      ...
      <form @submit.prevent="submitForm">
        ...
        <button class="mt-6 w-full bg-blue-600 hover
:bg-blue-700 text-white py-2 rounded-lg shadow">
          ส่งแบบประเมิน
        </button>
