    ...
    <div class="w-full max-w-md bg-white p-8 rounded-2x1 shadow-lg">
      ...
      <form @submit.prevent="signup" class="space-y-4">
        <div>
          ...
          <input v-model="form.fname" type="text" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-lg focus: ring-2
focus:ring-blue-400 focus: outline-none" placeholder="First Name" required />
        </div>
        <div>
          <label class="text-gray-700 font-medium">Last Name</label>
          <input v-model="form.lname" type="text" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-1g focus:ring-2
focus:ring-blue-400 focus: outline-none" placeholder="Last Name" required />
        </div>
        <div>
          <label class="text-gray-700 font-medium">Username</label>
          <input v-model="form.username" type="text" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-1g focus: ring-2
focus:ring-blue-400 focus: outline-none" placeholder="Username" required />
        </div>
        <div>
          <label class="text-gray-700 font-medium">Password</label>
          <input v-model="form.password" type="password" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-1g focus:ring-2
focus:ring-blue-400 focus: outline-none" placeholder="Password" required />
        </div>
        <div>
          <label class="text-gray-700 font-medium">Role</label>
          <select v-model="form.role" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2
focus:ring-blue-400 focus: outline-none">
        ...
        <button type="submit" class="w-full py-2 bg-blue-500 hover
